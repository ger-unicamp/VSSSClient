...
namespace rol
{
    ...
    ctrl::vec2 defender(unsigned int moving_robot_id, ctrl::vec2 ball, std::vector<fira_message::Robot> my_robots, std::vector<fira_message::Robot> enemy_robots);
    ctrl::vec2 defender_midfield(unsigned int moving_robot_id, ctrl::vec2 pos_ball, std::vector<fira_message::Robot> my_robots, std::vector<fira_message::Robot> enemy_robots);
