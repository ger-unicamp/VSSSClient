...
const double D_MIN = 0.02;
const double K_LINE = 16.0;

namespace rol
{
    unsigned int robot_next_to_target(unsigned int id_gkp, unsigned int last_idx, vector<fira_message::Robot> my_robots, fira_message::Ball target);
