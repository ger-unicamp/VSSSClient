...
public:
    ...
    static constexpr double FIELD_LIMIT_X = 0.75+0.15;//remover esse 5 aqui, soh pra fins de teste
    static fira_message::Ball ball;
    static constexpr double FIELD_LIMIT_Y = 0.65;//remover esse 5, soh pra fins de teste
