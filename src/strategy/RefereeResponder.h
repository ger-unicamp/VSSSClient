...
namespace plc
{
    ...
    const placements PK_B_B = {{{-0.7, 0.0, 90.0}, {-0.05, -0.3, 0.0}, {0.3, 0.03, -20}}}; // Blue Penalty Kick - Blue answer
    ...
    const placements PK_Y_Y = {{{0.7, 0.0, 90.0}, {0.05, 0.4, 0.0}, {-0.3, -0.03, -20}}}; // Yellow Penalty Kick - Yellow answer
