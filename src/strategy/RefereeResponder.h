...
namespace plc
{
    ...
    const placements PK_B_B = {{{-0.7, 0.0, 0.0}, {-0.05, -0.4, 0.0}, {0.3, -0.03, 25}}}; // Blue Penalty Kick - Blue answer
    ...
    const placements PK_Y_Y = {{{0.7, 0.0, 0.0}, {0.05, -0.4, 0.0}, {-0.3, 0.03, 25}}}; // Yellow Penalty Kick - Yellow answer
    const placements KO_Y_Y = {{{0.7, 0.0, 0.0}, {0.5, 0.0, 0.0}, {0.08, 0.02, 20}}}; // Kick Off Yellow - Yellow answer
