...
namespace plc
{
    ...
    const placements PK_B_B = {{{-0.7, 0.0, 90}, {-0.05, -0.3, 0.0}, {0.3, 0.03, -20}}}; // Blue Penalty Kick - Blue answer
    const placements PK_Y_B = {{{-0.75, 0.0, 90}, {0.05, 0.3, 0}, {0.05, -0.3 , 0}}}; // Yellow Penalty Kick - Blue answer
    ...
    const placements FB_Q1_Y = {{{0.7, 0.1, 90}, {0.5, 0.0, 0.0}, {0.6, 0.4, 0.0}}}; // Free Ball Quadrant 1 - Yellow answer
    ...
    const placements FB_Q4_Y = {{{0.7, -0.1, 90}, {0.5, 0.0, 0.0}, {0.6, -0.4, 0.0}}}; // Free Ball Quadrant 4 - Yellow answer
    const placements PK_B_Y = {{{0.75, 0.0, 90}, {-0.05, 0.3, 0.0}, {-0.05, -0.3, 0}}}; // Blue Penalty Kick - Yellow answer
    const placements PK_Y_Y = {{{0.7, 0.0, 90}, {0.05, 0.4, 0.0}, {-0.3, -0.03, -20}}}; // Yellow Penalty Kick - Yellow answer
