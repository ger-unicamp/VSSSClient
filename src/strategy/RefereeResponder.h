...
namespace plc
{
    ...
    const placements PK_Y_B = {{{-0.7, 0.0, 90}, {0.05, 0.3, 0}, {0.05, -0.3 , 0}}}; // Yellow Penalty Kick - Blue answer
    ...
    const placements PK_B_Y = {{{0.7, 0.0, 90}, {-0.05, 0.3, 0.0}, {-0.05, -0.3, 0}}}; // Blue Penalty Kick - Yellow answer
