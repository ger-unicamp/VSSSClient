...
namespace plc
{
  ...
  const placements PK_Y_B = {{{-0.75, 0.0, 0}, {0.05, 0.2, 0}, {0.05, -0.3 , 0}}}; // Yellow Penalty Kick - Blue answer
  ...
  const placements GK_Y_B = {{{-0.7, 0.0, 90.0}, {0.2, -0.45, 0.0}, {0.2, 0.45, 0.0}}}; // Yellow Goal Kick - Blue answer
  ...
  const placements PK_Y_Y = {{{0.7, 0.0, 90.0}, {0.05, -0.5, 0.0}, {-0.3, 0.03, 25}}}; // Yellow Penalty Kick - Yellow answer
  ...
  const placements GK_B_Y = {{{0.7, 0.0, 90.0}, {-0.2, 0.45, 0.0}, {-0.2, -0.45, 0.0}}}; // Blue Goal Kick - Yellow answer
